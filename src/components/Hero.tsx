  ...
  return (
    <section id="top" className="py-24 text-center scroll-mt-20">
      <Image
        ...
        height={128}
        priority
        className="mx-auto mb-6 rounded-full border border-ink/10 object-cover"
      />
      <h1 className="text-5xl md:text-6xl font-bold text-ink mb-6">Dhairya Arya</h1>
      <p className="text-xl text-blue-600 dark:text-blue-300 mb-4">Full-Stack Developer</p>
