export default function About() {
  return (
    <section id="about" className="py-20 scroll-mt-20">
      <h2 className="text-3xl font-bold text-ink text-center mb-10">About</h2>
      <div className="max-w-3xl mx-auto border border-ink/10 rounded-2xl p-8 bg-ink/5 backdrop-blur-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-ink/60">
          <div>
            <span className="text-ink/90 font-semibold">Web Development</span>
            <p>Conestoga College, Waterloo, ON — Graduated with Distinction (2022–2023)</p>
          </div>
          <div>
            <span className="text-ink/90 font-semibold">B.Eng, Information Technology</span>
